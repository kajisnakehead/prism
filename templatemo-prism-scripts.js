...
// Portfolio data for carousel
        ...
        const portfolioData = [
            {
                ...
                linkTo: 'stats', // Ini ID Section (Internal)
            ...
            },
            {
                ...
                linkTo: 'https://cloud.domainanda.com', // Ini Subdomain (Eksternal)
                buttonText: 'Open Cloud'
            },
            {
                id: 3,
                ...
                linkTo: 'https://google.com', // Ini Link Eksternal
                buttonText: 'Visit Source'
            },
            {
                id: 4,
                title: 'Cyber Defense',
        ...
        function handleNavigation(target) {
            // Cek apakah target mengandung 'http' (link eksternal/subdomain)
            if (target.startsWith('http')) {
                window.open(target, '_blank'); // Membuka di tab baru
            } else {
                // Jika bukan link, gunakan fungsi scroll internal yang sudah ada
        ...
        function createCarouselItem(data, index) {
            ...
            item.innerHTML = `
                <div class="card">
                    ...
                    <button class="card-cta" onclick="handleNavigation('${data.linkTo}')">
                        ${data.buttonText || 'Generate'}
                    </button>
                </div>
            `;
